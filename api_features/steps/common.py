...
def step_impl(context):
    api_result = context.event.api.retorno.json()
    valida_lista_dados(context, api_result)


# REFACTOR: in english, e eh uma classe o codigo abaixo!
        ...
        for expected_column in expected_columns:
            ...
            if isinstance(row_api_value, list):
                ...
                if expected_result is None:
                    ...
                    expected_result = [
                        int(x) if x.isdigit() else define_value(context, x.strip()) for x in expected_result_splited
                    ]
