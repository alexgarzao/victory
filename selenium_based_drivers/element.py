...
class BaseElement(Definition):
    def __init__(self, driver, screen_name, name, internal_id):
        super().__init__()
        self.driver = driver
...
#                return el
            if el and el.is_enabled() and el.is_displayed():
                return el
            time.sleep(1)
        return None
...
class IdElement(BaseElement):
    def __init__(self, driver, screen_name, name, internal_id):
        super().__init__(driver, screen_name, name, internal_id)
