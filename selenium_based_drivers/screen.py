...
class Screen(Definition):
    ...
    def add_id_element(self, name, internal_id):
        self.__add_element(name, IdElement(self.driver, self.name, name, internal_id))

    def add_text_element(self, name, internal_id):
        self.__add_element(name, TextElement(self.driver, self.name, name, internal_id))

    def add_name_element(self, name, internal_id):
        self.__add_element(name, NameElement(self.driver, self.name, name, internal_id))

    def add_xpath_element(self, name, internal_id):
        self.__add_element(name, XpathElement(self.driver, self.name, name, internal_id))

    def add_automation_id_element(self, name, internal_id):
        self.__add_element(name, AutomationIdElement(self.driver, self.name, name, internal_id))

    def add_class_name_element(self, name, class_name):
        self.__add_element(name, ClassNameElement(self.driver, self.name, name, class_name))

    def add_css_selector_element(self, name, css):
        self.__add_element(name, CssSelectorElement(self.driver, self.name, name, css))
